    ...
    <article className="surface-card p-5">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="space-y-2">
          <p className="text-lg font-semibold tracking-tight sm:text-xl">{issue.title}</p>
          <p className="max-w-2xl text-sm text-muted-foreground">{issue.summary}</p>
        </div>
      ...
      <dl className="mt-5 grid gap-5 border-t border-border/70 pt-4 md:grid-cols-2">
